...
@section('container')
    ...
    <header class="py-4">
        <div class="container-fluid py-2 text-center">
            <h1 class="h1 fw-normal text-success mb-0"><b>Hallo {{ auth()->user()->fullname }}</b></h1>
        </div>
    </header>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="text-center">
                                                <h3 class="text-success"><b>Selamat Bergabung bersama BIMBA Rainbow Kids
                                                    </b>
                                                </h3>
                                                                ...
                                                                <table class="table text-sm mb-0 table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-right">
                                                                                {{ $jadwal->nama_lengkap }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="text-right">Paket Dipilih</td>
                                                                            <td class="text-right">
                                                                                {{ $jadwal->jenis_paket }}</td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-right">
                                                                                @if ($jadwal->status_bayar == 'Y')
                                                                                    <span class="text-success">Pembayaran
                                                                                        Diterima</span>
                                    ...
                                    <div class="card ">
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-primary"
                                                href="{{ route('get_status_pembayaran', auth()->user()->id) }}">Cek</a>
                                        </div>
                                    </div>
                                </div>
                            @else
                                <div class="container">
                                    <div class="card">
                                        <div class="card-header text-center">
                                            <h2><b>Status Pembayaran Anda Sedang Di Validasi, Harap Menunggu Notifikasi di
                                                    Halaman Home atau Nomor
                                                    Anda Akan Dihubungi
                                                    Oleh Pihak Admin.</b></h2>
                                            <h2><b>Apabila Pembayaran Secara 'CASH' Silahkan Kunjungi Alamat BIMBA Rainbow
                                                    Kids Muktiwari, Pada MAPS
                                                    Di Bawah ini</b></h2>
                                        </div>
                                    </div>
                                </div>

    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header border-bottom">
                <h3 class="h4 mb-0">Edit Pekerjaan</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('m_pekerjaanupdate', $pekerjaan_edit->id) }}" method="POST" class="form-horizontal">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control @error('jenis_pekerjaan') is-invalid @enderror"
                                ...
                                value="{{ old('jenis_pekerjaan', $pekerjaan_edit->jenis_pekerjaan) }}">

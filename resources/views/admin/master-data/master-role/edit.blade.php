...
@section('container')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('m_roleupdate', $role_edit->id) }}" method="POST" class="form-horizontal">
                    @csrf
                    @method('put')
                    <div class="row">
                        <label class="col-sm-3 form-label">Edit Nama Role</label>
                        <div class="col-sm-9">
                            <input class="form-control @error('role_name') is-invalid @enderror" name="role_name"
                                placeholder="Nama Role" type="text"
                                value="{{ old('role_name', $role_edit->role_name) }}">
                            @error('role_name')
